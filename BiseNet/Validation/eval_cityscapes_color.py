...
def main(args):
    ...
    #     return model
    state_dict = torch.load('model_best.pth')['model']
    prefix = 'module.'
...
#         plt.show()
        ...
        label_color.permute(1,2,0)
#         tensor_rgb = label_color.permute(1, 2, 0)

# # Convert the tensor to a NumPy array
#         array_rgb = tensor_rgb.numpy()

#         # Display the NumPy array as an RGB image using Matplotlib
